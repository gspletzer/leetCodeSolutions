...
var flow = (superClass => {
  ...
  return _temp = class extends superClass {
    ...
    getArrowLikeExpressions(node, disallowInvalid) {
      ...
      return partition(arrows, node => node.params.every(param => this.isAssignable(param)));
    }
...
class ExpressionParser extends LValParser {
  ...
  parseParenAndDistinguishExpression(canBeArrow) {
    ...
    if (canBeArrow && this.shouldParseArrow() && (arrowNode = this.parseArrow(arrowNode, exprList))) {
